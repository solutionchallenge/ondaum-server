...
var PredefinedRoutes = []fx.Option{
	...
	dependency.HttpRoute("GET", "/diagnoses/papers", diagnosis.NewListDiagnosisPaperHandler),
	dependency.HttpRoute("GET", "/diagnoses/papers/:paper_id", diagnosis.NewGetDiagnosisPaperHandler),
